...
/**
 * Extrai o novo título e aplica real_escape_string,
 * que escapa caracteres especiais para evitar injeção de SQL.
 */
$titulo = $conn->real_escape_string($dados["titulo"]);

/**
 * Cria a query SQL que atualiza/altera o campo do título da tabela
